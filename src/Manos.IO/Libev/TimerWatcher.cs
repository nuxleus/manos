...
namespace Libev
{
    internal class TimerWatcher : Watcher, ITimerWatcher
    {
        ...
        private readonly Action<TimerWatcher, EventTypes> callback;
        ...
        public TimerWatcher(TimeSpan repeat, Loop loop, Action<TimerWatcher, EventTypes> callback)
            ...
            : base(loop)
        {
            ...
            this.repeat = repeat;
            watcher_ptr = manos_timer_watcher_create(after.TotalSeconds, repeat.TotalSeconds, unmanaged_callback,
        ...
        private static extern IntPtr manos_timer_watcher_create(double after, double repeat,
